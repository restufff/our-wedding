...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    return {
        ...
        openGraph: {
            ...
            images: [
                {
                    url: `https://tr-invitation.my.id/api/og?guest=${encodeURIComponent(decodedName)}&ext=.jpg`,
                    width: 1200,
                    height: 630,
        ...
        twitter: {
            ...
            title: `Undangan Pernikahan Restu & Tanya ✨`,
            description: `${decodedName}, kami mengundang Anda untuk hadir dan menjadi bagian dari hari spesial kami. Sabtu, 28 Maret 2026 · Bengkulu, Seluma.`,
            images: [`https://tr-invitation.my.id/api/og?guest=${encodeURIComponent(decodedName)}&ext=.jpg`],
        },
    };
}
