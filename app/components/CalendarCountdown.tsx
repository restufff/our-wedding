            ...
            <div className="bg-white/40 backdrop-blur-md border border-white/50 rounded-[2rem] p-6 md:p-8 shadow-2xl relative overflow-hidden">
                ...
                <div className="grid grid-cols-4 gap-1 md:gap-2 text-center text-[#366998]">
                    <div className="flex flex-col items-center">
                        ...
                        <span className="text-[8px] md:text-[9px] uppercase tracking-widest opacity-50 mt-1">{t('countdown.days')}</span>
                    </div>
                    <div className="flex flex-col items-center">
                        <span className="text-xl md:text-2xl font-serif font-bold tabular-nums leading-none">
                            {timeLeft.hours}
                        </span>
                        <span className="text-[8px] md:text-[9px] uppercase tracking-widest opacity-50 mt-1">{t('countdown.hours')}</span>
                    </div>
                    <div className="flex flex-col items-center">
                        <span className="text-xl md:text-2xl font-serif font-bold tabular-nums leading-none">
                            {timeLeft.minutes}
                        </span>
                        <span className="text-[8px] md:text-[9px] uppercase tracking-widest opacity-50 mt-1">{t('countdown.minutes')}</span>
                    </div>
                    <div className="flex flex-col items-center">
                        <span className="text-xl md:text-2xl font-serif font-bold tabular-nums leading-none">
                            {timeLeft.seconds}
                        </span>
                        <span className="text-[8px] md:text-[9px] uppercase tracking-widest opacity-50 mt-1">{t('countdown.seconds')}</span>
                    </div>
                </div>
